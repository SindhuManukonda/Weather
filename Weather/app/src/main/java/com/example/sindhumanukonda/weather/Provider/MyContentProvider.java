...
public class MyContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.example.sindhumanukonda.weather.provider.MyContentProvider";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        {
            case WEATHER:
                rowsDeleted = sqlDB.delete(MyDBHandler.TABLE_CITIES,
                        selection,
                        selectionArgs);
                break;
            case WEATHER_ID:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch(uriType)
        {
            case WEATHER:
                ...
                id = sqlDB.insert(MyDBHandler.TABLE_CITIES, null, values);
                break;
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        queryBuilder.setTables (MyDBHandler.TABLE_CITIES);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        {
            case WEATHER:
                rowsUpdated = sqldb.update(MyDBHandler.TABLE_CITIES,
                        values,
                        selection,
                        selectionArgs);
                break;
